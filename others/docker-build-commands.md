...
#2. mvn clean, install
docker build --build-arg JAR_FILE=target/*.jar -t nholuongut/kube-notifications-microservice:1.0.0 .
docker push nholuongut/kube-notifications-microservice:1.0.0

# 2.0.0 
#1. Update Notification Contoller Java to V2, 
#2. Update pom.xml version to 2.0.0
#3. mvn clean, install
docker build --build-arg JAR_FILE=target/*.jar -t nholuongut/
kube-notifications-microservice:2.0.0 .
docker push nholuongut/kube-notifications-microservice:2.0.0
...
docker push nholuongut/kube-notifications-microservice:3.0.0-AWS-XRay 
