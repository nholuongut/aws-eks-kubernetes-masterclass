package com.nholuongut.restservices.configuration;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleAccessDeniedException(AccessDeniedException ex, WebRequest request) {
		...
		if (acceptHeaderValue.contains(MediaType.TEXT_XML_VALUE)
			...
			apiError.setMessage(
					"Access denied. If you think you should have access to this resource, please contact nholuongut support.");
			apiError.setDebugMessage(ex.getMessage());
			return buildResponseEntity(apiError);
		}
	}
	...
	protected ResponseEntity<Object> handleGenericException(Exception ex, WebRequest request) {
		...
		if (acceptHeaderValue.contains(MediaType.TEXT_XML_VALUE)
			...
			apiError.setMessage(
					"Something went wrong, Please try again later! If the problem persists, please contact nholuongut support.");
			apiError.setDebugMessage(ex.getMessage());
			return buildResponseEntity(apiError);
		}
	}
