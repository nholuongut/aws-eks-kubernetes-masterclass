package com.nholuongut.restservices.authorizationserver.users.controllers;
...
import com.nholuongut.restservices.authorizationserver.users.dtos.EmailMessage;
import com.nholuongut.restservices.authorizationserver.users.dtos.UserModel;
import com.nholuongut.restservices.authorizationserver.users.entities.User;
import com.nholuongut.restservices.authorizationserver.users.repositories.UserRepository;
import com.nholuongut.restservices.authorizationserver.users.services.UserService;
...
public class UserController {
	...
	public ResponseEntity<?> registerUser(@RequestBody @Valid User user) {
		...
		response.put("message",
				"Thank you for registering with nholuongut User Management,  "
