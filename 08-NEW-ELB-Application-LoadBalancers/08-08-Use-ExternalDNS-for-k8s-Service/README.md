...
metadata:
  ...
  labels:
    app: app1-nginx
  annotations:
    external-dns.alpha.kubernetes.io/hostname: externaldns-k8s-service-demo101.nholuongut.com
spec:
  type: LoadBalancer
  selector:
    app: app1-nginx
...
- You should see **Record Sets** added for `externaldns-k8s-service-demo101.nholuongut.com`
...
```t
# nslookup commands
nslookup externaldns-k8s-service-demo101.nholuongut.com
```
### Access Application using DNS domain
```t
# HTTP URL
http://externaldns-k8s-service-demo101.nholuongut.com/app1/index.html
```
...
- The below records should be deleted automatically
  - externaldns-k8s-service-demo101.nholuongut.com
```
