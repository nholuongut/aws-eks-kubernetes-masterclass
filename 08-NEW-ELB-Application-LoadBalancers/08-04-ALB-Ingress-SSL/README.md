...
- Provide **desired domain: somedomain.com** and click on **check** (In my case its going to be `nholuongut`)
...
- Click on **Request a Certificate**
  ...
  - Add domain names: *.yourdomain.com (in my case it is going to be `*.nholuongut`)
...
- Go to **Hosted Zones**
  - Click on **yourdomain.com** (in my case nholuongut/fundamentals.com)
- Create a **Record Set**
  - **Name:** ssldemo101.nholuongut/fundamentals.com
  - **Alias:** yes
...
- **Access Application**
- **Important Note:** Instead of `nholuongut/fundamentals.com` you need to replace with your registered Route53 domain (Refer pre-requisite Step-02)
```t
# HTTP URLs
http://ssldemo101.nholuongut/fundamentals.com/app1/index.html
http://ssldemo101.nholuongut/fundamentals.com/app2/index.html
http://ssldemo101.nholuongut/fundamentals.com/

# HTTPS URLs
https://ssldemo101.nholuongut/fundamentals.com/app1/index.html
https://ssldemo101.nholuongut/fundamentals.com/app2/index.html
https://ssldemo101.nholuongut/fundamentals.com/
```
